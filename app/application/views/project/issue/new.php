	...
	<form method="post" action="">
		...
		<table class="form" style="width: 100%;">
			<tr>
				...
				<td>
					<input type="text" name="title" style="width: 100%;" value="<?php echo Input::old('title'); ?>" />
			...
			<tr>
				...
				<td>
					<textarea name="body" id="texteara_body" style="width: 100%; height: 150px;"><?php echo Input::old('body'); ?></textarea>
	...
	function IMGupload(input) {
		...
		xhttpUPLD.onreadystatechange = function() {
			...
			if (this.readyState == 4 && this.status == 200) {
				...
				if (xhttpUPLD.responseText == 0) {
					msg = msg + '<a href="' + img + '" target="_blank">';
				}
